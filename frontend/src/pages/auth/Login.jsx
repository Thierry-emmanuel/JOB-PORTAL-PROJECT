    ...
    <div className="kora-auth-root">
      ...
      <div className="kora-auth-left">
        ...
        <div className="kora-auth-left-content">
          ...
          <h1 className="kora-auth-left-title">Welcome Back to KORA</h1>
        ...
        <div className="kora-auth-form-container">
          ...
          <form className="kora-auth-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="kora-auth-options">
              ...
              <Link to="/forgot-password" className="kora-auth-link">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="kora-auth-footer">
            Don't have an account? <Link to="/register" className="kora-auth-link">Sign up here</Link>
          </div>
        </div>
      </div>
    </div>
