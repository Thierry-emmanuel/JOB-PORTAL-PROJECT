...
import {
  ...
  Menu, X, RefreshCw, AlertTriangle
} from "lucide-react";
  ...
  return (
    <div className="ed-skeleton-card">
      ...
      <div className="ed-skeleton-body">
        ...
        <div className="ed-skeleton ed-skeleton-line long" style={{ height: "28px", marginTop: "8px" }} />
        <div className="ed-skeleton ed-skeleton-line short" style={{ marginTop: "8px" }} />
      </div>
    </div>
  );
}
          ...
          <div className="ed-two-col">
            ...
            <div className="kora-section ed-section-tall">
              ...
              <div className="ed-applications-list">
                {loading ? (
                  [1, 2, 3].map((i) => (
                    <div key={i} className="ed-skeleton-card" style={{ padding: "12px 14px", borderRadius: "10px" }}>
                      <div className="ed-skeleton ed-skeleton-icon" style={{ width: 38, height: 38, borderRadius: "50%" }} />
                      <div className="ed-skeleton-body">
                        <div className="ed-skeleton ed-skeleton-line" style={{ width: "50%", height: "12px" }} />
                        <div className="ed-skeleton ed-skeleton-line" style={{ width: "70%", height: "10px", marginTop: "6px" }} />
                      </div>
                    </div>
                  ))
            ...
            <div className="ed-right-col">
              ...
              <div className="kora-section">
                ...
                <div className="ed-jobs-list">
                  {loading ? (
                    [1, 2].map((i) => (
                      <div key={i} className="ed-skeleton-card" style={{ borderRadius: "10px", padding: "14px" }}>
                        <div className="ed-skeleton-body">
                          ...
                          <div className="ed-skeleton ed-skeleton-line" style={{ height: "4px", marginTop: "14px" }} />
                        </div>
                      </div>
                    ))
                  ...
                  {loading ? (
                    [1, 2, 3].map((i) => (
                      <div key={i} style={{ padding: "10px 4px", borderBottom: "1px solid var(--kora-border)" }}>
                        ...
                        <div className="ed-skeleton ed-skeleton-line" style={{ height: "10px", width: "40%", marginTop: "6px" }} />
                      </div>
                    ))
                  ) : (
                    notifications.map((n) => (
          ...
          <div className="kora-section">
            ...
            <div className="ed-quick-actions">
              {[
                ...
                { icon: <FileText size={20} />,    label: "View Job Reports",     color: "#3b82f6", bg: "#3b82f618", action: null           },
