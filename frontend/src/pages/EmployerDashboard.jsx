    ...
    <div className="ds-root employer">
      ...
      {schedulerTarget && (
        <InterviewScheduler
          ...
          onScheduled={() => { updateApplicationStatus(schedulerTarget.id, 'SHORTLISTED'); setTimeout(() => setSchedulerTarget(null), 2500); }}
        />
      )}
                    ...
                    return (
                      <div key={app.id} className="ds-app-row">
                        ...
                        <div className="ds-app-actions">
                          <StatusSelect status={app.status} appId={app.id} onUpdate={updateApplicationStatus} />
                    ...
                    : jobPostings.map(job => (
                      <div key={job.id} className="ds-job-card">
                        ...
                        <div className="ds-job-actions">
                          ...
                          <button className="ds-btn ds-btn-danger ds-btn-sm" onClick={() => updateJobPostingStatus(job.id, 'EXPIRED')}>
                            <X size={11} /> Close
                          </button>
                        </div>
                      </div>
            ...
            <div className="ds-card-body">
              <div className="ds-quick-grid">
                {[
                  ...
                  { icon: <Video size={20} />,     label: 'Schedule Interview',    color: '#1565C0', bg: '#EFF6FF', action: () => { const s = applications.find(a => a.status === 'SHORTLISTED'); if (s) setSchedulerTarget(s); } },
