/**
 * EmployeeDashboard.jsx  (v3 — final)
 * ─────────────────────────────────────────────────────────────
...
/* ─────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────── */
const STATUS_CONFIG = {
  'Under Review':        { bg:'#FFF7ED', text:'#C2410C', dot:'#F97316',  Icon: Eye },
  'Interview Scheduled': { bg:'#F0FDF4', text:'#166534', dot:'#22C55E',  Icon: CalendarCheck },
  Rejected:              { bg:'#FEF2F2', text:'#991B1B', dot:'#EF4444',  Icon: XCircle },
  Hired:                 { bg:'#ECFDF5', text:'#065F46', dot:'#10B981',  Icon: CheckCircle2 },
  Applied:               { bg:'#EFF6FF', text:'#1E40AF', dot:'#3B82F6',  Icon: FileText },
  Shortlisted:           { bg:'#FAF5FF', text:'#6B21A8', dot:'#A855F7',  Icon: Star },
};
const DEFAULT_STATUS = { bg:'#F9FAFB', text:'#374151', dot:'#9CA3AF', Icon: AlertCircle };
...
const StatusBadge = memo(({ status }) => {
  ...
  return (
    <span className="ed-badge" style={{ background: c.bg, color: c.text }} aria-label={`Status: ${status}`}>
      ...
      <div className="ed-hero" role="banner">
        ...
        <div className="ed-hero-inner">
          ...
          <div className="ed-hero-ctas">
            <Link to="/jobs" className="ed-btn-primary">
        ...
        {completion < 100 && (
          <div className="ed-hero-progress">
            <div className="ed-hero-progress-meta">
              ...
              {completion < 50 && (
                <span className="ed-hero-progress-tip">Complete your profile to get noticed</span>
              )}
            </div>
