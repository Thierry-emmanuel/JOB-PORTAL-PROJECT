            ...
            <div style={{ background:'#fff', border:'1.5px solid #E5E7EB', borderRadius:16, padding:24, marginBottom:20 }}>
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:12, marginBottom:16 }}>
                {[
                  ...
                  job.type     && { icon:'💼', label: job.type.replace('_',' ') },
                  job.salary   && { icon:'💰', label: job.salary },
                ].filter(Boolean).map(f => (
                  <span key={f.label} style={{ display:'flex', alignItems:'center', gap:6, fontSize:13, color:'#374151', background:'#F9FAFB', border:'1.5px solid #E5E7EB', borderRadius:8, padding:'6px 12px' }}>
